...
use Radionovel\ArchiveStream\TarArchive as Tar;
use Radionovel\ArchiveStream\ZipArchive as Zip;
...
class Archive
{
     ...
     * @param resource $output_stream Output stream for archive contents.
     * @return ArchiveStream|TarArchive
     */
    ...
    /**
     * @param null $base_filename
     * @param array $opt
     * @param false|resource $output_stream
     * @return TarArchive|ZipArchive
     */
    ...
    protected function send($data)
    {
        ...
        $this->send_to_stream($data);
    }

    /**
     * @param $data
     */
    protected function send_to_stream($data)
    {
        is_null($this->output_stream) ? $this->to_output($data) : $this->to_stream($data);
    }

    /**
     * @param $data
     */
    protected function to_output($data)
    {
        echo $data;
    }
     ...
     * @param $data
     */
    protected function to_stream($data)
    {
        do {
